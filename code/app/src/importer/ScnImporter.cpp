...
namespace NRenderer {
bool ScnImporter::parseMtl(Asset& asset,
                           ifstream& file,
        ...
        if (token == "")
            ...
            if (type == "Int") {
                ...
                spMaterial->registerProperty(key,
                                             PW::Vec3Type{Vec3{v1, v2, v3}});
            } else if (type == "Vec4") {
                float v1, v2, v3, v4;
                ss >> v1 >> v2 >> v3 >> v4;
                spMaterial->registerProperty(
                    key, PW::Vec4Type{Vec4{v1, v2, v3, v4}});
            } else if (type == "RGB") {
                float v1, v2, v3;
                ss >> v1 >> v2 >> v3;
                spMaterial->registerProperty(key,
                                             PW::RGBType{Vec3{v1, v2, v3}});
            } else if (type == "RGBA") {
                float v1, v2, v3, v4;
                ss >> v1 >> v2 >> v3 >> v4;
                spMaterial->registerProperty(
                    key, PW::RGBAType{Vec4{v1, v2, v3, v4}});
            }
        } else if (token == "End") {
            break;
        } else {
...
bool ScnImporter::parseMdl(Asset& asset,
                           ifstream& file,
                           map<string, size_t>& mtlMap) {
    string currline;
    ...
    while (getline(file, currline)) {
        ...
        if (token == "")
            ...
            asset.modelItems[asset.modelItems.size() - 1]
                .model->nodes.push_back(asset.nodeItems.size());
